...
class Services {
  ...
  String clientId = "AQ3scENOhvTBq6uxiN84xyx3xf7vWgxjmGc1pME_n3fAxrSnG92gSl2S0U-9mTIvR-Zei9DA-yyCUEFh";
  String secret = "EDqf7ZtWpHow9nJw3m3iQwjou7ahHSBVEiAYOevHE-t0mzPXhNuGkXlZwPLNzYqt__hB1jo-YPg3kwyO";

  // for creating the payment request with Paypal
  Future<Map<String, String>> createPaypalPayment(transactions, accessToken) async {
    try {
      var response = await http.post(Uri.https("api.sandbox.paypal.com", '/v1/payments/payment'),
  ...
  Future<String> getAccessToken() async {
    try {
      ...
      var response = await client.post(Uri.https("api.sandbox.paypal.com", '/v1/oauth2/token', {'grant_type': 'client_credentials'}));
