            ...
            GestureDetector(
              onTap: (() => {
                    Get.defaultDialog(
                      ...
                      content: Container(padding: EdgeInsets.all(15), child: Text('Are you sure you want to delete this address?')),
                      actions: [
                        TextButton(
                          onPressed: () {
                            Get.back();
                          },
                          child: MyButton(label: 'Stornieren', width: Get.width * 0.27, color: primaryColor),
                        ),
                        TextButton(
                          onPressed: () {
...
class BillingAddresses extends GetView<UserController> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Get.to(Address(returnPage: 'billing', type: 1));
                    },
                    child: menuItem(
                      text: "Adres Ekle",
                      icon: Icons.pin_drop,
                ...
                controller.billing_addresses.length != 0
                    ? Expanded(
                        child: Container(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              for (var i in controller.billing_addresses) addresItem(title: i.label, phone: i.area, adres: i.address, id: i.id)
                            ],
                          ),
                        ),
                      ))
